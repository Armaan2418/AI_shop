...
const MOCK_PRODUCTS = [
  { _id: '1',  name: 'iPhone 15 Pro Max',      category: 'phones',      price: 144900, originalPrice: 159900, rating: 4.8, reviewCount: 2145, image: 'https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=400&q=80', badge: 'AI Pick', inStock: true },
  ...
  { _id: '3',  name: 'AirPods Pro 2nd Gen',     category: 'audio',       price: 24900,  originalPrice: 26900,  rating: 4.7, reviewCount: 3210, image: 'https://images.unsplash.com/photo-1600294037681-c80b4cb5b434?w=400&q=80', badge: 'Sale',    inStock: true },
  ...
  { _id: '5',  name: 'Sony WH-1000XM5',        category: 'audio',       price: 25990,  originalPrice: 34990,  rating: 4.8, reviewCount: 4120, image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&q=80', badge: 'AI Pick', inStock: true },
  { _id: '7',  name: 'PS5 DualSense',           category: 'gaming',      price: 6490,   originalPrice: 6990,   rating: 4.7, reviewCount: 5400, image: 'https://images.unsplash.com/photo-1606813907291-d86efa9b94db?w=400&q=80', badge: 'Sale',    inStock: true },
  { _id: '8',  name: 'Samsung 4K Monitor',      category: 'accessories', price: 42999,  originalPrice: 52999,  rating: 4.5, reviewCount: 430,  image: 'https://images.unsplash.com/photo-1527443224154-c4a573d5f6b4?w=400&q=80', badge: null,      inStock: true },
  ...
  { _id: '14', name: 'Leather Handbag',         category: 'fashion',     price: 7499,   originalPrice: 9999,   rating: 4.7, reviewCount: 876,  image: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&q=80', badge: 'AI Pick', inStock: true },
  { _id: '15', name: 'Matte Lipstick Set',      category: 'makeup',      price: 1499,   originalPrice: 1999,   rating: 4.8, reviewCount: 2310, image: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&q=80', badge: 'Sale',    inStock: true },
  { _id: '16', name: 'Slim Fit Denim Jacket',   category: 'clothing',    price: 2999,   originalPrice: 4499,   rating: 4.6, reviewCount: 540,  image: 'https://images.unsplash.com/photo-1551537482-f2075a1d41f2?w=400&q=80', badge: null,      inStock: true },
  { _id: '17', name: 'Foundation & Concealer',  category: 'makeup',      price: 2499,   originalPrice: null,   rating: 4.7, reviewCount: 1890, image: 'https://images.unsplash.com/photo-1631214499178-338dc7a3e0cb?w=400&q=80', badge: 'AI Pick', inStock: true },
];
